...
class CustomTextFormField extends StatelessWidget {
  CustomTextFormField({
    ...
    this.filled = true,
    this.validator,
    this.onChanged, this.enable, this.TextInputFormat,
  ...
  Widget get textFormFieldWidget => SizedBox(
        ...
        child: TextFormField(
          ...
          style: textStyle ?? CustomTextStyles.bodyLargeff696969.copyWith(
  ...
  InputDecoration get decoration => InputDecoration(
        ...
        prefixIcon: prefix??SizedBox(width: 16.h,),
        prefixIconConstraints: prefixConstraints??BoxConstraints(maxWidth: 16.h,maxHeight: 56.h),
        suffixIcon: suffix,
        // suffixIconConstraints: suffixConstraints??,
        suffixIconConstraints: suffixConstraints,
        isDense: true,
        contentPadding: contentPadding ?? EdgeInsets.only(top:  16.h,right: 16.h,bottom: 16.h),
