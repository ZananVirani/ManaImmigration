...
class MyAccountScreen extends GetWidget<MyAccountController> {
  ...
  Widget build(BuildContext context) {
    ...
    controller.descriptionEditTextController.text =
      ...
      body: ListView(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                controller.nameEditTextController.text,
                style: theme.textTheme.titleMedium!.copyWith(
                  color: AppColor.black,
                  fontSize: 17.fSize,
            ...
            Container(
              padding: EdgeInsets.only(
                  top: 16.h, left: 16.h, right: 16.h, bottom: 39.h),
              decoration: BoxDecoration(
                color: AppColor.lightGray,
                borderRadius: BorderRadius.circular(8.h),
              ),
            ...
            Container(
              ...
              child: Text(
                controller.countryEditTextController.text,
                style: theme.textTheme.titleMedium!.copyWith(
                  color: AppColor.black,
                  fontSize: 17.fSize,
                  fontWeight: FontWeight.w400,
            ...
            Container(
              ...
              child: Text(
                controller.genderEditTextController.text,
                style: theme.textTheme.titleMedium!.copyWith(
                  color: AppColor.black,
                  fontSize: 17.fSize,
                  fontWeight: FontWeight.w400,
        ...
        return SizedBox(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ColumnItemModel model = controllers
