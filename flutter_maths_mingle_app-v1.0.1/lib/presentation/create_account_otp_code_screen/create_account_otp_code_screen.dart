...
class CreateAccountOtpCodeScreen
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: PrefData.getAppBar(onTap: () => Get.back(),text: 'Enter 4 Digits code'.tr),
          ...
          return SafeArea(
            child: Form(
              ...
              child: Column(children: [
                GetBuilder<CreateAccountOtpCodeController>(builder: (controller) {
                  return Padding(
                    padding : EdgeInsets.only(left: 14.h,right: 14.h,top: 40.h),
                ...
                Padding(
                    ...
                    child: Row(
                        ...
                        children: [
                          ...
                          controller.sendOtp? Padding(
                            padding:  EdgeInsets.only(left: 4.h),
                            child: Countdown(

                              seconds: 30,
                              build: (BuildContext context, double time) => Text(time.toString(),style: CustomTextStyles.titleSmallPrimary),
