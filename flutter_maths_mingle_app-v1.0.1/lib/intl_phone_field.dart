...
import 'package:flutter_maths_mingle_app/country_picker_dialog.dart';
...
class IntlPhoneField extends StatefulWidget {
  ...
  const IntlPhoneField({
    ...
    this.magnifierConfiguration, this.textController,
  }) : super(key: key);
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Container(height: 40,width: 1,color: AppColor.black40,),
                const SizedBox(width: 16),
              ],
            ),
          ),
