...
class AppColor{
  ...
  static  Color primaryColor = const Color(0xFFDA7BCA);
  static  Color primaryLightColor = const Color(0xFFFDEEFA);
  static  Color secondaryLightColor = const Color(0xFFFFE2E1);
  static  Color secondaryULtaColor = const Color(0xFFFFF1F0);
  static  Color lightBorderColor = const Color(0xFFF4F7F6);
